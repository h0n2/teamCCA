...
class PrepareGraphNodes(object):
    ...
    def __init__(self, bolt, uri, user, password):
        print("Init...")
        #dbString = "bolt://neo4jdb:7687"
        #userName =  "user1"
        #userPass = "user1"

        self.graph = Graph(scheme="bolt", host="neo4j", port=7687, secure=True, auth=(user, password))
...
# x = PrepareGraphNodes("bolt","neo4jdb",7687, "user1", "user1")
