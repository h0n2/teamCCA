...
sc = SparkContext(appName="AminerKafkaSpark_2")
ssc = StreamingContext(sc,5)  # 10 seconds 
...
kafkaStream = KafkaUtils.createStream(ssc,'zookeeper:2181','consumer2',{'aminer1':1})
